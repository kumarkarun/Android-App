...
import com.android.project.viewPager.InfoActivity;
import com.android.project.viewPager.adapter.TravelViewPagerAdapter;
...
/**
 * Created by Karun on 8/12/16.
 */
public class ActivityViewPager extends AppCompatActivity implements ExpandingFragment.OnExpandingClickListener{
    @Bind(R.id.viewPager)
    ViewPager viewPager;
    ...
    private List<Travel> generateTravelList(){
        ...
        for(int i=0;i<1;++i){
            travels.add(new Travel("GroceryApp", R.drawable.splash, "CIS-600 Android Programing", "This Course is about AP"));
            travels.add(new Travel("Karun", R.drawable.karun, "CIS-600 Android Programing", "MS CS"));
            travels.add(new Travel("Amit", R.drawable.amit, "CIS-600 Android Programing ", "MS CE "));
            travels.add(new Travel("Thanks", R.drawable.shop, "AP", "Thank you"));
        }
        return travels;
    }
